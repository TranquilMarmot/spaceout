...
public class ModelManager {
	...
	private static void initModel(int model){
		switch(model){
		case SHIP1:
			ship1 = ModelLoader.loadObjFile(MODEL_PATH + "ships/ship1.obj", 0.25f, TextureManager.SHIP1);
			break;
		case LASERBULLET:
			laserbullet = ModelLoader.loadObjFile(MODEL_PATH + "laserbullet.obj",25.0f, TextureManager.LASERBULLET);
			break;
		}
	}
}
